...
ContactPop = {
    ...
    // pathToContactPop : '', // relative path to the Contact-Pop directory - no longer needed

    contactHeadline : 'Contact',
    headerBgColor : '#fff', // background color of overlay panel header
    ...
    openButtonSelector : '.contact', // set this to use jQuery selectors in addition to the hrefs - string (ex: '.contact, #contact-link')
    ...
    appendOverlay : function() {
        ...
        ContactPop.obj.panelHeadline = $( '<h2 id="contact-pop-header"><span>' + ContactPop.contactHeadline + ' ' + clickedLocation + '</span></h2>') . appendTo( ContactPop.obj.panel );
        ...
        ContactPop.obj.loading.append('<img src="assets/images/ajax-loader.gif" alt="" id="contact-pop-loading-gif" />');
    },
    ...
    showOverlay : function() {
      ...
      if ( typeof(ContactPop.obj.overlay) == 'undefined' || jQuery(ContactPop.obj.overlay).is(':hidden') ) {
    ...
    init : function() {
        ...
        ContactPop.obj.ctas.click( function(ev) {
          ev.preventDefault();
          clickedLocation = jQuery(this).html();
        ...
        if ( jQuery.browser.msie && jQuery.browser.version < 7 ) overlayImg.src = 'assets/images/overlay-ie6.png';
        else overlayImg.src = 'assets/images/overlay.png';
    }
};
